...
test("el constructor agrega grupos semánticos por capacidad de página y mismo título", async () => {
  ...
  assert.match(editor, /const capacity = pageCellCount\(base\)/);
  assert.match(editor, /index \+= capacity/);
