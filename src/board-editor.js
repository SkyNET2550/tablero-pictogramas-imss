...
async function makeBoardSvgImage(board) {
  ...
  const parts = [
    ...
    `<text x="478" y="92" text-anchor="start" font-family="Arial" font-size="17" font-weight="700" fill="#004b93">TABLERO DE COMUNICACIÓN POR PICTOGRAMAS</text>`,
    `<text x="478" y="126" text-anchor="start" font-family="Arial" font-size="30" font-weight="800" fill="#004b93">${escapeSvg(board.title.toUpperCase())}</text>`,
    `<rect x="45" y="165" width="726" height="3" fill="#004b93"/>`
  ];
