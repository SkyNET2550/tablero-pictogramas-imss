...
(async () => {
  ...
  *{box-sizing:border-box}body{margin:0;background:#fff;font-family:Arial}.page{position:relative;width:816px;height:1056px;padding:16px 45px 45px;background:#fff;overflow:hidden}
  ...
  .grid{height:795px;display:grid;grid-template-columns:repeat(4,1fr);grid-template-rows:repeat(5,1fr);gap:7px}.cell{border:2.5px solid #0757a5;border-radius:10px;padding:6px;display:flex;flex-direction:column;align-items:center;justify-content:space-between}.cell img{width:100%;height:calc(100% - 28px);object-fit:contain}.cell strong{font-size:16px;text-align:center}.empty{border-style:dashed;border-color:#aaa}
